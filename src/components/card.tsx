...
export const Card: FC<CardProps> = ({
	...
	const cardContent = (
		<div className={cardContentClass}>
			...
			<div>
				<h2
					className={`font-semibold text-base text-gray-800 dark:text-white ${!horizontal ? "mt-4" : ""}`}
				>
					{title}
				</h2>
				<div
					className={`font-normal text-sm text-gray-600 dark:text-gray-400 leading-6 ${!horizontal ? "mt-1" : ""}`}
				>
					<p>{children}</p>
				</div>
			</div>
