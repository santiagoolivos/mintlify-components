...
const calloutStyles = {
	...
	warning:
		"border-amber-500/20 bg-amber-50/50 dark:border-amber-500/30 dark:bg-amber-500/10 text-amber-900 dark:text-amber-200",
	...
	check:
		"border-emerald-500/20 bg-emerald-50/50  dark:border-emerald-500/30 dark:bg-emerald-500/10 text-emerald-900 dark:text-emerald-200",
};
...
export const Callout: FC<CalloutProps> = ({ type, children }) => {
	...
	return (
		<div
			className={`callout my-4 px-5 py-4 overflow-hidden rounded-2xl flex gap-3 border ${calloutStyles[type]}`}
		>
